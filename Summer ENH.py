...
for varname, data in extratropics.items():
    n_time = data.shape[0]
    summer_months = [i for i, month in enumerate(months) if month in [6, 7, 8]] # Empty subset of wintsummerer, june, july, aug
...
plt.title(" Extratropical NH – Hierarchical Clustering Dendrogram (Summer Months)")
...
plt.title("Cluster Map – Extratropical NH (summer Means)")
