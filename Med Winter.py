...
# Convert 2d spatial gris to 1d lsit for matrix
...
plt.title(" Mediterranean – Hierarchical Clustering Dendrogram (Winter Months)")
plt.xlabel("Cluster") 
plt.ylabel("Distance")
plt.show()
...
plt.pcolormesh(
    ...
    transform=ccrs.PlateCarree(), # Cartopys Carrée projection
    shading='nearest'
)

plt.title("Cluster Map – Mediterranean (Winter Means)")
